...
_MAPILLARY_VISTAS_SIMPLIFIED = 'mapillary_vistas_simplified'
_PASCAL = 'pascal'
...
_DATASET_MAX_ENTRIES = {
	...
	_MAPILLARY_VISTAS_SIMPLIFIED: 16,
    _PASCAL: 256,
}
...
def create_mapillary_vistas_label_colormap():
  ...
  """
  """
  Water: colormap changed from [0, 170, 30] to [151, 219, 242]
  """
  return np.asarray([
      [165, 42, 42],
      [0, 192, 0],
...
def create_mapillary_vistas_simplified_colormap():
  """Creates a label colormap used in Mapillary Vistas segmentation benchmark.
...
def get_mapillary_vistas_simplified_name():
  return _MAPILLARY_VISTAS_SIMPLIFIED
...
def create_label_colormap(dataset=_PASCAL):
  ...
  elif dataset == _MAPILLARY_VISTAS_SIMPLIFIED:
    return create_mapillary_vistas_simplified_colormap()
