...
OUTPUT_DIR="${WORK_DIR}/tfrecord_test"
mkdir -p "${OUTPUT_DIR}"

IMAGE_FOLDER="${MVD_ROOT}/images"
LIST_FOLDER="${MVD_ROOT}/index"

# Resize images for evaluation 
RESIZE_IMG_Folder="${MVD_ROOT}/ResizedImages/images"
RESIZE_LABEL_Folder="${MVD_ROOT}/ResizedImages/SegmentationClassRaw"
